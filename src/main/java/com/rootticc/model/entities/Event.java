...
public class Event {
	...
	public int hashCode() {
		...
		result = prime * result + ((urgenceLevel == null) ? 0 : urgenceLevel.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (title == null) {
			...
			return false;
		if (urgenceLevel == null) {
			if (other.urgenceLevel != null)
				return false;
		} else if (!urgenceLevel.equals(other.urgenceLevel))
			return false;
		if (user == null) {
			if (other.user != null)
				return false;
